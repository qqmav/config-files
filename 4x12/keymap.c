...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MAIN] = LAYOUT_ortho_4x12(
    ...
    KC_BSLS, KC_GRV,  KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_RALT, KC_RCTL, KC_LBRC, KC_RBRC
  ),

  [_RAISE] = LAYOUT_ortho_4x12(
 KC_F12,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
 _______, KC_VOLD, KC_MPLY, KC_VOLU, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
 KC_CAPS, KC_MPRV, KC_MSTP, KC_MNXT, _______, _______, _______, _______, _______, _______, _______, _______,
